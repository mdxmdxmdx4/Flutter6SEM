                              ...
                              onPageChanged: (index, reason) {
                                if (reason == CarouselPageChangedReason.manual) {
                                  if (index > state.currentIndex) {
                                    context.read<CarouselBloc>().add(CarouselNextEvent());
                                  } else {
                                    context.read<CarouselBloc>().add(CarouselPrevEvent());
                                  }
                                }
                              },
                            ),
                              ...
                              return Builder(
                                builder: (BuildContext context) {
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: i == 1 ? Color.fromRGBO(29, 163, 166, 0.8) : (i == 2 ? Color.fromRGBO(252, 239, 219, 1) : (i == 3 ? Colors.pink : Colors.blue)),
